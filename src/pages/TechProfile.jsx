              ...
              <div className="flex flex-col items-center justify-center">
                <div className="grid w-full grid-cols-2 gap-10">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <button
                      className="inline-flex h-10 w-32 items-center justify-center rounded-md bg-[#cccccc] px-4 py-2 text-black transition duration-300 ease-in-out hover:bg-red-500"
