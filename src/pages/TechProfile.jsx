      ...
      <div className="flex-grow bg-[#0F1217] text-white p-1">
        <section className="flex flex-col items-center justify-center section-wrapper sm:px-0 border-b-2">
          ...
          <h1 className="text-2xl font-extralight text-center text-[#cccccc] mb-5 p-5">
            ...
            visibility tool. Now, I'm excited to turn the page and dive into the next chapter of my professional
            journey!
          </h1>
          <button
            onClick={() => {
          ...
          <div className="mb-8 mt-8">
            ...
            <div className="border-b-[1px] border-gray-700 mb-5">
              ...
              <p className="text-xl font-extralight text-[#cccccc] tracking-wide mb-4">
                ...
                creating software. I developed a web application for automotive use, and a took part in a group project
